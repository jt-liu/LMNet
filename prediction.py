...
from models.ACV_LM import __models__
from utils import *
from utils.KittiColormap import *

cudnn.benchmark = True

parser = argparse.ArgumentParser(description='LMNet')
...
parser.add_argument('--loadckpt', default='ckpts/KITTI15/acv+lm/Dec07_15/checkpoint_000899.ckpt', help='load the weights from a specific checkpoint')
